...
(function() {
  ...
  el.textContent = [
    ...
    /* --- Smooth scrolling + safe area top --- */
    ".rvu-content { -webkit-overflow-scrolling: touch; overscroll-behavior-y: contain; scroll-behavior: smooth; padding-top: env(safe-area-inset-top, 0px); }",
    ...
    /* --- Safe area nav padding (bottom only) --- */
    ".rvu-nav-bar { padding-bottom: env(safe-area-inset-bottom, 12px) !important; }",
