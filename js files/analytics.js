...
function Analytics({ data, db, setView, showComp, toggleComp }) {
  ...
  var ytdProcs = countEncounters(ytdEntries);
  ...
  return (<div style={S.page}>
    ...
    <div style={S.statsRow}>
      ...
      <div style={S.statCard}><div style={{ ...S.statValue, color: "#10b981" }}>{fmtDollar(ytdComp, showComp)}</div><div style={S.statLabel}>Total Comp</div></div>
    </div>
    ...
    {topCats.length > 0 && <div style={{ ...S.card, background: "linear-gradient(135deg, #1e293b, #0f172a)", border: "1px solid #334155", padding: 16 }}>
      ...
      <div style={{ fontSize: 11, color: "#64748b", marginBottom: 14 }}>Total RVUs and top procedure per category</div>
        ...
        return (<div key={c.name} style={{ padding: "10px 0", borderBottom: i < topCats.length - 1 ? "1px solid rgba(51,65,85,0.3)" : "none" }}>
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "baseline", marginBottom: 6 }}>
            ...
            <div style={{ display: "flex", alignItems: "baseline", gap: 8 }}>
              <span style={{ fontSize: 11, color: "#64748b" }}>{c.count} proc{c.count !== 1 ? "s" : ""}</span>
